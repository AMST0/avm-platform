...
export default function AdminOverviewPage() {
    ...
    const activities = [
        { text: 'Zara mağazası güncellendi', time: '5 dk önce', type: 'update', icon: Store },
        { text: 'Yaz Festivali etkinliği eklendi', time: '1 saat önce', type: 'create', icon: Calendar },
        { text: 'Ana slider sıralaması değiştirildi', time: '2 saat önce', type: 'update', icon: Layers },
        { text: 'Kampanya popup aktif edildi', time: '3 saat önce', type: 'create', icon: MessageSquare },
    ];
                        ...
                        <div className="flex items-center gap-4">
                            <div className="px-6 py-4 rounded-2xl bg-white/5 backdrop-blur-xl border border-white/10">
                                <div className="flex items-center gap-2 mb-1">
                                    ...
                                    <span className="text-xs text-white/50">Bugünkü Ziyaret</span>
                                </div>
                            ...
                            <div className="px-6 py-4 rounded-2xl bg-white/5 backdrop-blur-xl border border-white/10">
                                <div className="flex items-center gap-2 mb-1">
                                    ...
                                    <span className="text-xs text-white/50">Dönüşüm</span>
                                </div>
